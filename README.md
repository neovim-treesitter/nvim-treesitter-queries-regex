...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-regex/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-regex/actions/workflows/validate.yml)

Neovim tree-sitter queries for **regex**, part of the
...
- [ ] Changes are scoped to `regex` — do not include files for other languages
